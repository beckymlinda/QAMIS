<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-brand-primary">Add role</h2>
    ...
    <div class="mx-auto max-w-4xl space-y-6 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <form method="POST" action="{{ route('roles.store') }}" class="space-y-6">
            ...
            <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
                ...
                <input name="name" value="{{ old('name') }}" placeholder="e.g. finance_officer" required pattern="[a-z][a-z0-9_]*" class="mt-1 w-full rounded-md border-gray-300">
            ...
            <div class="flex gap-3">
                <button type="submit" class="rounded-lg px-4 py-2 text-sm font-semibold text-white" style="background:var(--brand-primary, #0f2744)">Create role</button>
